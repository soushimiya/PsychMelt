...
class Character extends FlxSprite {
    ...
    public function loadCharacterFile(json:Dynamic) {
        ...
        setupSprite(json);
        loadAnimations(json);
        setupProperties(json);
    }

    private function setupSprite(json:Dynamic) {
        scale.set(1, 1);
        updateHitbox();
    ...
    private function loadAnimations(json:Dynamic) {
    ...
    private function addAnimation(anim:AnimArray) {
    ...
    private function setupProperties(json:Dynamic) {
